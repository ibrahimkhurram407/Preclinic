        ...
        <div class="header">
            ...
            <ul class="nav user-menu float-right">
                <li class="nav-item dropdown has-arrow">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="<?php global $doctor_id; echo "account-details.php?table=doctb&id=$doctor_id&page=index.php";?>">My Profile</a>
            ...
            <div class="dropdown mobile-user-menu float-right">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="<?php echo "account-details.php?table=doctb&id=$doctor_id&page=index.php";?>">My Profile</a>
                    <a class="dropdown-item" href="logout.php">Logout</a>
                </div>
            </div>        
        </div>
